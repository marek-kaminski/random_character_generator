...
def simple_printing():
    ...
    for i in range(0, character_number):
        ...
        if random_percentage_armour <= 30:
            ...
            armour = "kurtka 1pp"
        elif random_percentage_armour <=94:
            armour = "kutrka z ochraniaczami 2pp"
        elif random_percentage_armour <=99:
            armour = "kamizelka lekka 3pp"
        else:
        ...
        final_stalker = ("\n", name, " ", level), ("wzrost=", wzrost, "cm", " waga=", waga, " wiek=", wiek), ('hp = ', hp), ("walka wręcz = ", walkawrecz,
